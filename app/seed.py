...
CATEGORY_NAMES = {"12": "관광지", "14": "문화시설", "15": "축제공연행사", "25": "여행코스",
                  "28": "레포츠", "32": "숙박", "38": "쇼핑"}
DUMMY_POST_CATEGORIES = ("여행후기", "정보공유", "질문", "동행구함")
DUMMY_POST_CONTENTS = (
...
def seed_dummy_posts(db, count=DUMMY_POST_COUNT):
    ...
    category_cycle = cycle(enumerate(DUMMY_POST_CATEGORIES))
    rows = []
    for index in range(count):
        ...
        rows.append(Post(
            ...
            content=DUMMY_POST_CONTENTS[category_index].format(location=location.title),
